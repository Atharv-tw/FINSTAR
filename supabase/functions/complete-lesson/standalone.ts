/**
 * Complete Lesson - STANDALONE VERSION
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const progressRef = userRef.collection("learningProgress").doc(lessonId);
    ...
    // Calculate rewards
    let xpEarned = 50; // Base XP for completing lesson
    let coinsEarned = 25; // Base coins
